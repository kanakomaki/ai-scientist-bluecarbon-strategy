...
This JSON will be automatically parsed, so ensure the format is precise."""
    ...
    try:
        text, msg_history = get_response_from_llm(
            prompt=citation_first_prompt_template.format(   # changed by KK 2024APR30
    ...
    try:
        text, msg_history = get_response_from_llm(
            prompt=citation_second_prompt_template.format(   # changed by KK 2024APR30
...
def perform_writeup(
    ...
    small_model = "meta-llama/llama-3.3-70b-instruct", # changed by KK 2024APR#
    big_model="meta-llama/llama-3.3-70b-instruct", # changed by KK 2024APR#"o1-2024-12-17",
...
#                "experimental/blank_icml_latex", latex_folder, dirs_exist_ok=True
                "ai_scientist/experiments/blank_icml_latex", latex_folder, dirs_exist_ok=True
            )
        ...
        try:
            vlm_client, vlm_model = create_vlm_client("openai/gpt-4.1-nano") # changed by KK 2024APR30: hardcoded to use openai/gpt-4.1-nano
            desc_map = {}
        ...
        response, msg_history = get_response_from_llm(
            # msg=combined_prompt,
            prompt=combined_prompt, # changed by KK 2024APR30
            client=big_client,
...
"""
            ...
            reflection_response, msg_history = get_response_from_llm(
                ...
                prompt=reflection_prompt, # changed by KK 2024APR30
                client=big_client,
                model=big_client_model,
                system_message=big_model_system_message,
                msg_history=msg_history,
