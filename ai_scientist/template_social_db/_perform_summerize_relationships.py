# Summarize stakeholder relationships with json data and LLM, and visualize them with networkx and pyvis.
# 
...
# def extract_relationships_llama(summary_json: str, model: str):
...
#     all_relationships = []
#     for scheme, entries in data.items():
#         # check if nested "data" key exists
...
def visualize_graph(G, output_img="stakeholder_graph.png"):
...
def export_interactive_graph(G, output_html="stakeholder_graph.html"):
...
def main():
    ...
    parser.add_argument("--input", type=str, default="outputs/20250416_112225_merged_summaries.json")
    parser.add_argument("--output", type=str, default="stakeholder_graph.graphml")
